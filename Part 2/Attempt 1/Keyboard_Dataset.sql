...
ud."price" as "Price", us."enjoyment(/10)" as "Enjoyment", ud."bottom_out (grams)" as" Weight", ud.sound as "Sound", ud.tactility as "Tactility", uda.avg_wpm as "Date Average", uda.avg_accuracy as "Date Accuracy" 
